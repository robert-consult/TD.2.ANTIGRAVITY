...
app.get("/metrics", (req, res) => {
  ...
  res.send(
    [
      ...
      "# HELP admin_data_export_bytes_written_total Total bytes written for admin export artifacts",
      "# TYPE admin_data_export_bytes_written_total counter",
      `admin_data_export_bytes_written_total ${exportMetrics.bytesWrittenTotal}`,
